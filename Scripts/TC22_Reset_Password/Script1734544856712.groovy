...
WebUI.click(findTestObject('Object Repository/Page_/span_Forgot Password'))

WebUI.click(findTestObject('Object Repository/Page_/label_Enter your email'))

WebUI.setText(findTestObject('Object Repository/Page_/input_Enter your phone number or email_outl_281146'), 'qotb@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_/button_Reset Password'))
